...
@__DSOCacheEntry_name.9 = internal constant [23 x i8] c"libaot-MauiApp3.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 8
	%struct.DSOCacheEntry {
		i64 144970911, ; hash 0x8a4149f, from name: MauiApp3.dll.so
		i8 0, ; ignore
	...
	; 53
	%struct.DSOCacheEntry {
		i64 543998432, ; hash 0x206cc1e0, from name: aot-MauiApp3.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 122
	%struct.DSOCacheEntry {
		i64 1202309521, ; hash 0x47a9c991, from name: libaot-MauiApp3
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 252
	%struct.DSOCacheEntry {
		i64 2384099086, ; hash 0x8e1a770e, from name: MauiApp3
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 448
	%struct.DSOCacheEntry {
		i64 4176023288, ; hash 0xf8e90ef8, from name: aot-MauiApp3
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 455
	%struct.DSOCacheEntry {
		i64 4284481452, ; hash 0xff5fffac, from name: libaot-MauiApp3.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
