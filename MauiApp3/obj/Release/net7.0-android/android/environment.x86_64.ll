...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"3c14c462-666c-4858-8492-91a8efc84487\00", align 16
...
@__DSOCacheEntry_name.39 = internal constant [23 x i8] c"libaot-MauiApp3.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 39
	%struct.DSOCacheEntry {
		i64 1937715951600748579, ; hash 0x1ae426643ac54823, from name: libaot-MauiApp3.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 40
	%struct.DSOCacheEntry {
	...
	; 53
	%struct.DSOCacheEntry {
		i64 2381341242724919613, ; hash 0x210c393e4d9b293d, from name: aot-MauiApp3.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 117
	%struct.DSOCacheEntry {
		i64 5252032302620259285, ; hash 0x48e2f78d828eb3d5, from name: MauiApp3
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 127
	%struct.DSOCacheEntry {
		i64 5790177977536711142, ; hash 0x505ad831615d89e6, from name: libaot-MauiApp3
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 224
	%struct.DSOCacheEntry {
		i64 9349519077793626827, ; hash 0x81c02a10bca07acb, from name: aot-MauiApp3
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 269
	%struct.DSOCacheEntry {
		i64 11323015478679244430, ; hash 0x9d236e9600ed0e8e, from name: MauiApp3.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
